...
/**
 * @fileOverview Sophisticated AI-powered scam detection engine inspired by Wisely.
 *
...
**Output Format:**
Produce a valid JSON object matching the output schema. Focus on high-fidelity intelligence extraction.`,
});
